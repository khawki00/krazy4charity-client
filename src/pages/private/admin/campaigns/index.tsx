    ...
    },
    {
      ...
      render:(_text:string, record:CampaignTypeProps)=>(
        <div className="flex gap-5">
           ...
           <Button onClick={() => {setSelectedCampaign(record);
            setShowCampaignDonations(true);
          }}
           size="small" className="bg-primary border-secondary border"><ListCheck size={13}/></Button>
           </Tooltip>
            <Button size="small" className="bg-primary border-secondary border" onClick={() => onDelete(record._id)}>
         <Trash size={13}/>
         </Button>
         <Button size="small" className="bg-primary border-secondary border">
         <Pencil size={13} onClick={()=> navigate(`/admin/campaigns/edit/${record._id}`)}/>
         </Button>
        </div>
      )
    }
