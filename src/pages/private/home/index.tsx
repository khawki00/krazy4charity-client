  ...
  return (
   ...
   <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mt-5">
    {campaigns.map((campaign) =>(
      <div className="rounded border border-solid bg-white border border-solid hover:border-secondary cursor-pointer"
        key={campaign._id}
        ...
        <div className="flex flex-col gap-1 p-3 bg-white">
          <h1 className="text-xs bg-white text-center font-semibold">{campaign.name}</h1>
      </div>

       <div className="px-2 pb-2"> <Progress
          percent={Number(
            (
