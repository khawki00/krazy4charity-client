...
function CheckoutForm({
  ...
  return (
   <Modal onCancel={onClose} open={open} onClose={onClose} title="COMPLETE YOUR DONATION PAYMENT" footer={null}>
    <form onSubmit={handleSubmit}>
        ...
        <div className="flex justify-end gap-5 mt-5">
            ...
            <Button type="primary" htmlType="submit" loading={loading}>Donate</Button>
        </div>
    </form>
   </Modal>
  )
