...
function CampaignInfoPage() {
  ...
  return (
    <div>
      <Button  className="bg-secondary text-primary" onClick={() => navigate("/")}>Back To Campagin</Button>
      {loading && (
        ...
        <div className="mt-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 mt-5 gap-5">
            <div className="col-span-2">
              ...
              <div className="flex gap-5 mt-5">
                {campaignData.images.map((image, index)=>(
                  <Image src={image} key={index} className="w-24 h-24 rounded" height={80} width={100}/>
                ))}
              </div>
            ...
            <div className="col-colspan-1">
                <DonationsCard campaignData={campaignData} reloadCampaignData={getData}/>
            </div>
          </div>
        </div>
      )}
